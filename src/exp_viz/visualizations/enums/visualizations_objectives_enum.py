...
class VisualizationsObjectivesEnum(Enum):
    ...
    shows the features in the y-axis sorted by their impact in the model's 
    ...
    the most important features, sorted from most important to least important, 
    ...
    contribution. The third part gives the list of features, also sorted by 
